...
<div class="blogheader">
  <h1>Logo Design Quote Request Form</h1>
 <p>Please fill out the form and send it back to me. Once I have received the completed form, I will review your 
  requirements and provide you with a detailed quote for your logo design project.

 <br><br> Thank you for considering my services! I look forward to working with you to create a fantastic logo 
 that represents your brand effectively.</p>
 <br><br>
</div>

<form action="logodesign_form.php" method="post">
<div class="logodesignform">
    ...
    <label for="country">Do you currently have a logo?</label>
    <select id="country" name="country">
      <option value="yes">Yes</option>
      <option value="no">No</option>
    </select>

    <p>If yes, please provide the current logo for reference.</p>
    ...
    <label for="subject">What is the primary message you want your logo to convey?</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

    <label for="subject">Are there any specific colors you'd like to be used in the logo? (If yes, please specify)</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

    <label for="subject">Do you have any preferred design styles for the logo? (Elegant, Modern, Minimalistic, etc.)</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

    <label for="subject">Do you have any specific symbols or elements you'd like to include in the logo? (If yes, please specify)</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

<h2>Scope of Work</h2>

    <label for="subject">Do you need the logo to be used in print materials (business cards, brochures, etc.)?</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

    <label for="subject">Do you need the logo to be used on your website or social media profiles?</label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

    <label for="subject">Are there any specific file formats you require for the final logo? (e.g., .AI, .EPS, .PNG, etc.)
    </label>
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px"></textarea>

<h2>Timeline</h2>

<label for="fname">Do you have a specific deadline for the completion of the logo design?</label>
<input type="text" id="fname" name="firstname" placeholder="Your timeline..">

<h2>Budget</h2>

<label for="fname">Do you have a budget range in mind for this logo design project?</label>
